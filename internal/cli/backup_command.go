...
func (r *rootState) runBackupObject(
	...
	// tenant namespace of the source PVC and the repository resources, never
	// the storage location. The lifecycle verbs (status, resume, abort,
	// cleanup) resolve records the same way.
