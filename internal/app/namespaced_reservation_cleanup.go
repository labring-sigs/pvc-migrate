...
func (r *ReservationExecutor) ValidateCleanup(
	ctx context.Context,
...
func (r *ReservationExecutor) Cleanup(
	ctx context.Context,
	object *v1alpha1.Reservation,
	options ReservationCleanupOptions,
) error {
...
func (r *ReservationExecutor) prepareCleanup(
	ctx context.Context,
	object *v1alpha1.Reservation,
	options ReservationCleanupOptions,
) (*v1alpha1.Reservation, []reclaimVolume, []v1alpha1.ObjectReference, error) {
	if err := validateReservationObject(object); err != nil {
