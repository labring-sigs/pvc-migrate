...
func TestMigrationRunAndRollbackRecoverFromRejectedCheckpoint(t *testing.T) {
...
func TestMigrationAbortBeforePlanningDoesNotAccessResources(t *testing.T) {
...
func TestMigrationAbortRejectsActivatedVolumes(t *testing.T) {
	executor, object, store, _ := migrationExecutorFixture(t)
...
func TestMigrationPlanningResumeRestoresStateWhenSaveFails(t *testing.T) {
	executor, object, store, reserver := migrationExecutorFixture(t)
	object.Status.Plan = nil
