...
func (m *ClusterPodMigrationExecutor) FinalSync(
	ctx context.Context,
...
func (m *ClusterPodMigrationExecutor) ValidateFinalSync(
	ctx context.Context,
	object *v1alpha1.ClusterPodMigration,
) error {
	if err := validateClusterPodMigrationObject(object); err != nil {
...
func (m *ClusterPodMigrationExecutor) finalSyncWithProbes(
	ctx context.Context,
	object *v1alpha1.ClusterPodMigration,
...
func (m *ClusterPodMigrationExecutor) cleanupInterruptedFinalSync(
	ctx context.Context,
	object *v1alpha1.ClusterPodMigration,
) error {
