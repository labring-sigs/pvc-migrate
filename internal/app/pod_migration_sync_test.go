...
func TestPodMigrationFinalSyncResumesIncompleteVolumes(t *testing.T) {
...
func TestPodMigrationFinalSyncCompletionSaveRetry(t *testing.T) {
	executor, object, store, engine := podMigrationWarmFixture(t)
	executor.switcher = &scriptedSwitcher{client: executor.client}
...
func TestPodMigrationCutoverProbesBeforePause(t *testing.T) {
...
func TestPodMigrationFinalSyncStopsOnFenceLoss(t *testing.T) {
	executor, object, _, engine := podMigrationWarmFixture(t)
	executor.switcher = &scriptedSwitcher{client: executor.client}
