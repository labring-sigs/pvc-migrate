...
func (m *ClusterPodMigrationExecutor) ValidateCleanup(
	ctx context.Context,
...
func (m *ClusterPodMigrationExecutor) Cleanup(
	ctx context.Context,
	object *v1alpha1.ClusterPodMigration,
	options MigrationCleanupOptions,
) error {
...
func (m *ClusterPodMigrationExecutor) prepareCleanup(
	ctx context.Context,
	object *v1alpha1.ClusterPodMigration,
	options MigrationCleanupOptions,
) (*v1alpha1.ClusterPodMigration, []reclaimVolume, []v1alpha1.ObjectReference, error) {
	if err := validateClusterPodMigrationObject(object); err != nil {
	...
	indexes := clusterPodMigrationVolumeIndexes(preview.Status.Volumes)
