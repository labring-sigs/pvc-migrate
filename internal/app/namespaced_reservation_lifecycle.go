...
func (r *ReservationExecutor) RequestResume(
	ctx context.Context,
...
func (r *ReservationExecutor) FinalizeDeleted(
	ctx context.Context,
	object *v1alpha1.Reservation,
) error {
...
func (r *ReservationExecutor) ValidateAbort(object *v1alpha1.Reservation) error {
	return validateReservationObject(object)
}

func (r *ReservationExecutor) Abort(
	ctx context.Context,
	object *v1alpha1.Reservation,
) error {
