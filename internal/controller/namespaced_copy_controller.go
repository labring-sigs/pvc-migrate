...
type NamespacedCopyPlanner func(context.Context, *v1alpha1.Copy, string) (*domain.TransferPlan, error)

type CopyReconciler struct {
	store          *kube.CRDWorkflowStore[*v1alpha1.Copy]
	client         kubernetes.Interface
	planner        NamespacedCopyPlanner
...
func (r *CopyReconciler) Reconcile(
	ctx context.Context,
