...
func TestNamespacedCopyControllerOwnsPlanningResumeAndDeletion(t *testing.T) {
	...
	options := ManagerOptions{
		...
		NamespacedCopyPlanner: func(_ context.Context, request *v1alpha1.Copy, image string) (*domain.TransferPlan, error) {
	...
	r.namespacedCopy.checkCollision = func(_ context.Context, name string, namespaces []string) error {
