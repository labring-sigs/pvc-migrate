...
type NamespacedMigrationPlanner func(context.Context, *v1alpha1.Migration, string) (*domain.TransferPlan, error)

type MigrationReconciler struct {
	store          *kube.CRDWorkflowStore[*v1alpha1.Migration]
	client         kubernetes.Interface
	planner        NamespacedMigrationPlanner
...
func (r *MigrationReconciler) plan(
	ctx context.Context,
	object *v1alpha1.Migration,
) error {
	if r.planner == nil {
